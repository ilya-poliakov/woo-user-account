...
use Monolog\Logger;
use plugins\WooUserAccount\classes\base\ArrayHelper;
...
class Log extends Base
{
    ...
    {
        $filePath = WOO_USER_ACCOUNT_PLUGIN_URL . $this->loggersTargets[$target]['fileName'];
    ...
    protected function getLoggers()
    {
        ...
        foreach ($this->loggersTargets as $key => $target) {
            ...
            $file = WOO_USER_ACCOUNT_PLUGIN_URL . 'logs/' . $target['fileName'];
            $log = new Logger($key);
